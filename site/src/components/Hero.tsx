  ...
  return (
    <section className="px-4 pt-28 pb-16 text-center">
      ...
      <div className="flex justify-center gap-10 text-center">
        <div><div className="text-xl font-semibold tabular-nums">27%</div><div className="text-xs text-default-400">fewer tokens</div></div>
        ...
        <div><div className="text-xl font-semibold tabular-nums">MIT</div><div className="text-xs text-default-400">license</div></div>
      </div>
    </section>
  );
}
